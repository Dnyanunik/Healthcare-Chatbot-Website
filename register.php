...
<body onload="document.form1">
  <article class="card-body mx-auto" style="max-width: 400px;">
    ...
    <form name="form1" action="register.php" method="post" onsubmit="return validate();">
      ...
      <div class="form-group">
        <button type="submit" class="btn btn-primary btn-block" name="createAccount"> Create Account </button>
      </div> <!-- form-group// -->
      <p class="text-center">Have an account? <a href="login.php">Log In a our AI</a> </p>
    </form>
  </article>
  </div>
  ...
  <script src="images/script/register.js"></script>
</body>
