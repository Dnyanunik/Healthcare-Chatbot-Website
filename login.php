...
<head>
  ...
  <title>HealthCare Chatbot AI</title>
...
<body class="text-center">
  <form class="form-signin" action="login.php" method="post">
    <img class="mb-4" src="https://media.istockphoto.com/id/1467477321/vector/nurse-avatar-clipart-icon-vector-illustration-medical-service.jpg?s=1024x1024&w=is&k=20&c=wIwa2qegmr1i04DcyxcCX9XBlrZ_MTYXu13qhJhL73U=" alt="ok" width="72" height="72">
  ...
  <script src="images/script/login.js"></script>
</body>
